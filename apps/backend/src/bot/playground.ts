...
const players: PublicPlayer[] = [
  { id: 'p1', label: labelP1, isAlive: true },
  { id: 'p2', label: labelP2, isAlive: true },
  { id: 'p3', label: labelP3, isAlive: true },
  { id: 'p4', label: labelP4, isAlive: true },
  { id: 'p5', label: labelP5, isAlive: true }, // 봇이 맡은 자리
];
